...
function Sidebar(props) {
    ...
    const {mode, start, newMaze, gMessage, setStart, stopGame, createNewMaze, trainingInfo, setAgent} = props;
                ...
                <div className='maze-info-container'>
                    ...
                    <div className='environment-info'>
                        ...
                        */}
                        ...
                        {mode === "Training" &&
                            <div className='maze-info-card'>
                                <img src={agentPreviousPath} alt="path" className='info-image' />
                                <h4 className='info-name'>- Agent's Previous Path</h4>
                            </div>
                        }
                        */}
            ...
            {mode !== "Training" ? 
                ...
                <div className="game-info-childs child-three training" style={{ height: '10%' }}>
                    {trainingInfo.mazeType !== "show" && start && !trainingInfo.mazeInProgress ? 
                        ...
                        trainingInfo.mazeType === "show" ?
                        <button className='game-buttons left frozen-training-button'>SHOW</button> :
                    ...
                    {trainingInfo.mazeType !== "hide" && start && !trainingInfo.mazeInProgress ? 
                        ...
                        trainingInfo.mazeType === "hide" ? 
                        <button className='game-buttons right frozen-training-button'>HIDE</button> :
